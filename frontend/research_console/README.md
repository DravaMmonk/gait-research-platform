...
- `components/console/session-chat.tsx`
  owns the AI SDK chat boundary
...
- Keep global CSS scoped to theme tokens, browser/base rules, and shared chat surface selectors.
