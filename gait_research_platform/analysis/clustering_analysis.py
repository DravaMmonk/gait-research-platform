...
@register_analysis("clustering_analysis")
class ClusteringAnalysis(AnalysisTask):
    ...
    def run(
        ...
        raise NotImplementedError("clustering_analysis is reserved for a future extension.")
